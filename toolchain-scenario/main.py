...
def hex_crc16(str_in):
	_tmp = str_in.encode('ascii')
	_tmp = crc16.crc16xmodem(_tmp)
	return hex(_tmp)
...
if os.path.exists(world_file):
	with open(world_file) as json_data:
		...
		# C initialization
		out.write('/* Windless Bay for Amiga OCS -- (c) RESISTANCE.NO 2021 */\n')
		...
		# World constants
		out_h.write('/* Windless Bay for Amiga OCS -- (c) RESISTANCE.NO 2021 */\n')
